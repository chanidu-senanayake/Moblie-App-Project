...
import 'package:final_project/StoresPage/ligh%20vehical/lightparts.dart';
import 'package:final_project/services/database2.dart';
...
class LightHome extends StatefulWidget {
  ...
  @override
  State<LightHome> createState() => _HomeState();
}

class _HomeState extends State<LightHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => LightParts()));
        },

...
import 'package:final_project/StoresPage/heavy%20vehical/heavyparts.dart';
import 'package:final_project/services/database3.dart';
import 'package:flutter/material.dart';

class HeavyHome extends StatefulWidget {
  const HeavyHome({super.key});

  @override
  State<HeavyHome> createState() => _HomeState();
}

class _HomeState extends State<HeavyHome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => HeavyParts()));
        },
